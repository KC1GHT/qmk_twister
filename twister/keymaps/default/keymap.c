...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        LSFT_T(KC_Z),    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,   KC_COMM, KC_DOT,  RSFT_T(KC_SLSH),
         KC_LCTL, KC_LGUI, KC_LALT, MO(3),   LT(1, KC_SPC),     LT(2, KC_SPC),      KC_SLSH, KC_DOWN, KC_RIGHT
    ),
    [1] = LAYOUT(
          KC_1,       KC_2,       KC_3,     KC_4,       KC_5,      KC_6,       KC_7,        KC_8,       KC_9,       KC_0,    
         KC_MINUS,    KC_EQL,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_LBRC,    KC_RBRC,    KC_SCLN,   KC_QUOT,
           KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,   KC_TRNS,    KC_UP,    KC_TRNS,
           KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,                KC_TRNS,          KC_TRNS,           KC_SLSH, KC_DOWN, KC_RIGHT
     ),
    [2] = LAYOUT(
          S(KC_1),       S(KC_2),   S(KC_3),  S(KC_4),    S(KC_5),   S(KC_6),    S(KC_7),    S(KC_8),    S(KC_9),   S(KC_0),    
          S(KC_MINUS),   S(KC_EQL),    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,  S(KC_LBRC), S(KC_RBRC),   S(KC_SCLN),   S(KC_QUOT),
